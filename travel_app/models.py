...
class Travel(models.Model):
    ...
    travelers = models.ManyToManyField(User, related_name="Travelers", blank=True) #, null= True
...
class Travel_Journal(models.Model):
    ...
    travelers_in_journal = models.ManyToManyField(User, related_name="Travelers_in_journal",
